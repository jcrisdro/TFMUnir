...
class Speaker:
    ...
    json_path = "/Users/Vicll/AppData/Roaming/gcloud/application_default_credentials.json"
    ruta = "/Users/Vicll/OneDrive - UNIR/MASTER/SEMESTRE_2/TFM/IA/services/"
    ...
    def generateWithGoogle(self, text):
        ...
        ruta_archivo = self.ruta + "output.mp3"
